...
class User extends CI_Controller {
	...
	public function view($value='')
	{
		...
		if( $id == '' ){
			...
			$data['now'] 						=	$this->db->where('u.fld_id',$id)->select('u.*,"" As l_name')->get('tbl_user u')->row();
			// View Files
			$this->load->view('admin/include/header',$data);
			$this->load->view('admin/include/sidebar',$data);
	...
	public function log($value='')
	{
		...
		if( $id == '' ){
			...
			$data['pageSlug_two']				=	'User';
			$data['pageSlug_two_url']			=	base_url('admin/user');
			$data['pageSlug_three']				=	'User Log';
			$data['pageSlug_three_url']			=	base_url('admin/user.log');
			//Get Data
			$data['now'] 						=	$this->db->where('fld_user_id',$id)->get('tbl_user_log')->result();
			// View Files
			$this->load->view('admin/include/header',$data);
			$this->load->view('admin/include/sidebar',$data);
