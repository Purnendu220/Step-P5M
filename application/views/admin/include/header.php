                            ...
                            <li class=" <?php if($this->uri->segment(2)=="config"){echo 'active';} ?>">
                             ...
                             <li class=" <?php if($this->uri->segment(2)=="user"){echo 'active';} ?>">
                              ...
                              <li class=" <?php if($this->uri->segment(2)=="map"){echo 'active';} ?>">
                                <a href="<?php echo base_url('admin/map'); ?>"aria-expanded="true"><i class="fa fa-map-marker"></i><span>Map</span></a>
                            </li>
                            <li class=" <?php if($this->uri->segment(2)=="report"){echo 'active';} ?>">
                                <a href="<?php echo base_url('admin/report'); ?>"aria-expanded="true"><i class="fa fa-table"></i><span>Report</span></a>
                            </li>
