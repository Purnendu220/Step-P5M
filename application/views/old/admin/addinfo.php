        ...
        <div class="col-lg-6 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Add New Info</h4>
                            <form action="<?php echo base_url('admin/info/saveNew'); ?>" method="POST" enctype='multipart/form-data'>
                            <!-- <p class="text-muted font-14 mb-4">Here are examples of <code>.form-control</code> applied to each textual HTML5 <code>&lt;input&gt;</code> <code>type</code>.</p> -->
                            <div class="form-group">
                                <label for="example-text-input" class="col-form-label">Title</label>
                                <input class="form-control" type="text" value="" placeholder="Title"  id="fld_title" name="fld_title">
                            </div>
                            <div class="form-group">
                                <label for="example-text-input" class="col-form-label">Details</label>
                                <textarea class="form-control" placeholder="Details"  id="fld_details" name="fld_details"></textarea>
                            </div>
                            <div class="form-group">
