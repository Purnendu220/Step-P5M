                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('admin/location/saveNew'); ?>" method="POST" enctype='multipart/form-data'>
                            <!-- <p class="text-muted font-14 mb-4">Here are examples of <code>.form-control</code> applied to each textual HTML5 <code>&lt;input&gt;</code> <code>type</code>.</p> -->
                            <div class="form-group">
                                <label for="example-text-input" class="col-form-label">Location Name English</label>
                                <input class="form-control" type="text" value="" placeholder="Location Name English"  id="fld_name" name="fld_name" required>
                            </div>
                             <div class="form-group">
                                <label for="example-text-input" class="col-form-label">Location Name Arabic</label>
                                <input class="form-control" type="text" value="" placeholder="Location Name Arabic"  id="fld_name_ar" name="fld_name_ar" required>
                            </div>
                            <div class="form-group">
